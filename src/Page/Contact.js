...
<div className='col-md-2'> <span>EMAIL</span> <br/><p style={{fontSize:"20px"}}>something@tyler.com</p>
...
<div className='col-md-10'> <span>PHONE NUMBER</span> <br/><p style={{fontSize:"20px"}}>202-555-0188</p>
...
<div className='row pt-5 mt-5'>
  ...
  <div className='col-md-4 col-12'>
    <div className='col-md-12'>
    <p className='ms-5 mt-3'>©2022 Earth. All right reserved.</p>
    </div>
  </div>
</div>
